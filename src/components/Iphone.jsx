...
*/
// this is a glts convert into jsx components model->scene.glb 3d file in converted into all mesh jsx components
// this is the converter:https://github.com/pmndrs/gltfjsx
...
function Model(props) {
    ...
    // this contains mesh that covers color of phone
    const texture = useTexture(props.item.img);

    useEffect(() => {
      //object is used get key and value of all the materials
        ...
        // we call when the color button&size are changed
